...
, @NamedQuery(name = "Properties.findByPlaceAndPrice", query = "SELECT p FROM Properties p WHERE (p.price >= :priceMin AND p.price <= :priceMax) AND p.city LIKE :place")
, @NamedQuery(name = "Properties.findExpensivePlaces", query = "SELECT p FROM Properties p WHERE p.price >= :price AND p.city LIKE :place")
, @NamedQuery(name = "Properties.recentProperties", query = "SELECT p FROM Properties p WHERE p.dateAdded >= :dateAdded AND p.dateAdded <= :currentDate")
, @NamedQuery(name = "Properties.findPropertiesByAgentId", query = "SELECT p FROM Properties p WHERE p.agentId = :agentId")})
public class Properties implements Serializable {
    ...
    public Properties(Integer id, String berRating, int vendorId, Date dateAdded) {
        this.id = id;
    ...
    public Properties(String street, String city, Integer listing, Integer styleId,
            Integer typeId, Integer bedrooms, Float bathrooms, Integer squarefeet,
            String berRating, String description, Short garagesize, Integer gtype, 
            Double price, Integer agentId, Integer vendorId, Date dateAdded, 
            String lotsize, String photo){
        this.street = street;
        this.city = city;
        this.listingNum = listing;
